...
const services: { img: StaticImageData; title: string; description: string }[] = [
  ...
  },
  {
    ...
    description:
      'Ви маєте можливість обміняти або повернути придбаний товар потягом 14 днів з дня покупки за умови збереження товарного вигляду та відсутності слідів експлуатації та/або втручання.'
  }
];
